			...
			<div id="cartContent" data-faraway="">
				<table class="cartTable">
					<thead>
						<tr class="head">
							...
							<th scope="colgroup" id="th-product-box" colspan="2" style="width: 50%; margin: auto">상품정보</th>
							<th scope="col" id="th-unit-total-price">수량</th>
					...
					<tbody id="cartTable-sku">
						...
						<tr class="cart-deal-item " data-item-status="CHECKED"
							...
							<td class="cart-deal-item__image "><a
								href="//www.coupang.com/vp/products/1596362803?vendorItemId=70717508033"
								class="moveProduct"> 
								<img
							...
							<td class="unit-total-price">
								...
								<div class="unit-total-sale-price">수량</div>

							</td>
							<td class="unit-total-price">

								<div class="unit-total-sale-price">25,000원</div>
				...
				<div class="cart-total-price" data-total-price="25000"
					...
					<div class="cart-total-price__inner">
						<div class="price-area">
							...
							총 상품가격 <em class="final-product-price">25,000</em>원 <span
							...
							주문금액 <em class="final-order-price" data-final-order-price="25000">
								25,000원 </em>
						</div>
					</div>
				...
				<div class="order-buttons">
					<a id="continueShoopingBtn" class="goShopping logging"
						href="//www.coupang.com" data-view-type="shoppingCart"
