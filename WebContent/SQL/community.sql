...
VALUES (ANNOUNCEMENT_idx_seq.nextval, 'admin','공지사항1','오늘 모임 변경안내입니다.');
INSERT INTO ANNOUNCEMENT (idx,nickname,title,content)
VALUES (ANNOUNCEMENT_idx_seq.nextval, 'admin','공지사항2.','오늘 모임 변경안내입니다.');
INSERT INTO ANNOUNCEMENT (idx,nickname,title,content)
VALUES (ANNOUNCEMENT_idx_seq.nextval, 'admin','공지사항3.','오늘 모임 변경안내입니다.');
INSERT INTO ANNOUNCEMENT (idx,nickname,title,content)
VALUES (ANNOUNCEMENT_idx_seq.nextval, 'admin','공지사항4.','오늘 모임 변경안내입니다.');
INSERT INTO ANNOUNCEMENT (idx,nickname,title,content)
VALUES (ANNOUNCEMENT_idx_seq.nextval, 'admin','공지사항5.','오늘 모임 변경안내입니다.');

-- REVIEW TABLE 예시
INSERT INTO REVIEW (idx,productnum,productname,filename, nickname,title,content,point,commentcount)
VALUES (REVIEW_idx_seq.nextval, 1,'단감명작','gam.png','NYR','단감명작 후기','담가버리고 싶은맛',4,1);
...
INSERT INTO REVIEW (idx,productnum,productname,filename, nickname,title,content,point,commentcount)
VALUES (REVIEW_idx_seq.nextval, 8,'연꽃 담은 술 8도 850ml','연꽃 담은 술 8도 850ml12.png','CJW','연꽃술','연꽃향이 나요',3,1);
INSERT INTO REVIEW (idx,productnum,productname,filename, nickname,title,content,point)
VALUES (REVIEW_idx_seq.nextval, 16,'양반안동소주 23년산 로얄안동소주 45도 800ml','양반안동소주 23년산 로얄안동소주 45도 800ml145.png','KSH','안동소주','소주는 안동소주',4);
INSERT INTO REVIEW (idx,productnum,productname,filename, nickname,title,content,point,commentcount)
VALUES (REVIEW_idx_seq.nextval, 21,'엄청주 360ml','엄청주 360ml10.png','HYC','엄청주 후기','구아악',1,1);
...
-- QNA TABLE 예시
INSERT INTO QNA (idx,productnum,productname,filename, nickname,title,password,content,commentcount)
VALUES (QNA_idx_seq.nextval,21,'엄청주 360ml','엄청주 360ml10.png','HYC','엄청주 문의',1111,'구아악',1);
INSERT INTO QNA (idx,productnum,productname,filename, nickname,title,password,content,commentcount)
VALUES (QNA_idx_seq.nextval,21,'엄청주 360ml','엄청주 360ml10.png','CGH','궁중술 문의', null,'배송 얼마나 걸리나요?',1);
INSERT INTO QNA (idx,productnum,productname,filename, nickname,title,password,content,commentcount)
VALUES (QNA_idx_seq.nextval,null,null,null,'LDH','애플리즈', 1234,'대량 구매시 할인 가능?',1);
