...
<body>
<p style="float: right; display: block; margin-right: 200px; ">
<a href="../index.jsp" style="color: black; display: inline;">홈</a>
>이용약관
</p>
<br>
<br>
<h2 style="text-align: center; margin-left: 60px;">이용약관</h2>
<br>
<br>
<div style="border: 1px solid silver; background-color: #efebe9; width: 70%; margin: auto;">
	<div style="border: 1px solid silver; background-color: white; margin: 20px; font-size: 13px;">
	<div style="margin: 20px;'">
	
	제1조(목적) <br>
이 약관은 농농업회사법인 술공장(주)(전자상거래 사업자)가 운영하는 술공장(이하 “몰”이라 한다)에서 제공하는 인터넷 관련 서비스(이하 “서비스”라 한다)를 이용함에 있어 사이버 몰과 이용자의 권리.의무 및 책임사항을 규정함을 목적으로 합니다.<br>
※「PC통신, 무선 등을 이용하는 전자상거래에 대해서도 그 성질에 반하지 않는 한 이 약관을 준용합니다.」<br>
<br>
제2조(정의)<br>
① “몰”이란 농업회사법인 술공장(주)가 재화 또는 용역(이하 “재화 등”이라 함)을 이용자에게 제공하기 위하여 컴퓨터 등 정보통신설비를 이용하여 재화 등을 거래할 수 있도록 설정한 가상의 영업장을 말하며, 아울러 사이버몰을 운영하는 사업자의 의미로도 사용합니다.<br>
