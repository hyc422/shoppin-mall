...
<br>
<br>
<h2 style="text-align: center; margin-left: 60px;">개인정보처리방침</h2>
<br>
<br>
<div style="border: 1px solid silver; background-color: #efebe9; width: 70%; margin: auto;">
	...
	농업회사법인 술공장(주)는 (이하 "회사"는) 고객님의 개인정보를 중요시하며, "정보통신망 이용촉진 및 정보보호"에 관한 법률을 준수하고 있습니다. <br>
...
성명 : 김태주<br>
소속 : 영업부<br>
전화번호 : 043-218-7689<br>
이메일 : tj@sejongbrewery.co.kr<br>
<br>
o 개인정보보호책임자<br>
성명 : 김태주<br>
소속 : 영업부<br>
